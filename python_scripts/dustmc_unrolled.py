...
# Brainstorming implementation of DUST
# Parameters so far:
#     - S: Groundtruth measurements of shape (n x T)
#     - A: Measurement sensing matrix of shape (m x n)
#     - D: Dictionary matrix initialized by DCT of shape (n x d)
#     - X: Observed matrix of shape (m x T) (gotten from A.S) - denote final version of learnt A as AA. A^-1.X = S. 
    
#     Returns:
#     - S: Reconstructed matrix of shape (n x T)
#     
# Overall Model class forward pass recieves observed matrix X 
